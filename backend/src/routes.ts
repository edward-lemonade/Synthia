...
import { createSession, saveExistingProject, saveNewProject, listMine } from "./controllers/studio.controller";
...
router.post('/api/projects/get_mine', checkJwt, listMine);
