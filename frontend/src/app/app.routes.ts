...
export const routes: Routes = [
	{path: '', component: AppbarLayoutComponent, children: [
		...
		{path: 'discover', component: DiscoverPage, canActivate: []},
		{path: 'publish/:projectId', component: PublishPage, canActivate: [AuthGuard]},
		{path: 'track/:trackId', component: TrackPage, canActivate: []},
		{path: 'profile/:displayName', component: ProfilePage, canActivate: []},
	]},
